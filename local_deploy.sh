...
dfx canister create boomerang --specified-id bkyz2-fmaaa-aaaaa-qaaaq-cai

dfx deploy water_neuron --argument '(variant{Init=record{nicp_ledger_id=principal "buwm7-7yaaa-aaaar-qagva-cai"; wtn_ledger_id=principal "jcmow-hyaaa-aaaaq-aadlq-cai"; wtn_governance_id=principal "jcmow-hyaaa-aaaaq-aadlq-cai"}})' --mode reinstall -y
